...
$R \in [1.67, 1.98]$\,cm and moves every episode.
...
$0.000$ and $0.700$ deployed} --- two earlier heads, not the released one.

The absolute framing flatters us and the relative one does not: the largest gap
is on proprioception, $2.85$ against $2.13$\,cm, which is $34\%$ of the smaller
value and sits on the exact channel Layer 3 is about. The claim we can defend
is that no channel \emph{ordering} distinguishes the two heads, and that the
absolute differences are small beside the behavioural gap. A second caveat: the
substitution is between a
