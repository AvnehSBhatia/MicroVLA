...
They audit five manipulation benchmarks including all of LIBERO, and show a
$0.09$B probe with no language encoder scoring within one point of the best
published result on three of LIBERO's four splits, and $100.0\%$ on
...
\emph{which} object in a task carries the degeneracy.

Their result is the symptom. The radius is a candidate explanation for
