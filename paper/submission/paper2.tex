...
retired, and the eight ways our own results fooled us.
...
\subsection{Eight ways a result fooled us, and the one thing they share}
...
(Table~\ref{tab:fooled}).

That is the pattern, and it took eight instances to see it. Not one of these
...
\bottomrule
\end{tabular}
\caption{Eight self-inflicted errors and their repairs. Every one was found by
