...
about the \emph{embodiment} as much as the files. \S\ref{sec:adm} makes that
precise, and \S\ref{sec:refute} reports our attempt to demonstrate it, which
failed.
...
least two: the thing to be moved and the place to put it. They are reported separately because the split is the finding, not a
technicality.
...
The outcome comes first here; the previous version of this paper buried it. \textbf{The experiment does not decide the
question, and we can say precisely why: the instrument tops out at $16$
