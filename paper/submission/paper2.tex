...
retired, and the ways our own results fooled us.
...
\subsection{Seven ways a result fooled us, and the one thing they share}
...
That is the pattern, and it took seven instances to see it. Not one of these
was a bug in a measurement. Each was a decision about \emph{which slice of a
correct instrument's output got written down}: which trials had finished, which
axes were compared, which tolerances were swept, which tasks were counted,
which of two estimates was quoted. \textbf{A verifier that recomputes every
...
\bottomrule
\end{tabular}
\caption{Seven self-inflicted errors and their repairs. Every one was found by
