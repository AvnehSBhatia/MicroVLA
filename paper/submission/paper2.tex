...
($r = +0.52$), the opposite of what the lookup reading predicts. The goal supply is
...
given the loosest constants ($R > 1$\,cm) score $10/40$. The correlation between placement radius and success is
$r = +0.52$. We attribute that to the informal lookup reading rather than to
Proposition~\ref{prop:lookup}, whose hypotheses do not hold here anyway ---
admissibility fails on the container, A1 is task-dependent, and our policy is
outside Corollary~\ref{cor:sep}'s class. Artifact:
